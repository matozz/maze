...
export interface TextFieldProps
  ...
  resize?: boolean;
  /**
   * The unstyled prop disabled textfield animations (outlined)
   */
  unstyled?: boolean;
  focused?: boolean;
...
>(
  (
    { unstyled, prefixElement, suffixElement, ...oldProps }: TextFieldProps,
    ref
  ) => {
      ...
      <>
        <label
          className={[
            ...
            err,
            `maze-textfield--${size}`,
            unstyled ? `maze-textfield--unstyled` : "",
          ].join(" ")}
          style={{
            ...cssProperties,
            ...style,
        ...
        >
          ...
          <div className="maze-textfield--suffix">{suffixElement}</div>
